            ...
            <div class="ttw-music-player" style="opacity: 1;">
                <div class="player jp-interface jp-state-playing">
                    <div class="album-cover">
                        <span class="img" style="opacity: 1;">
                            <img src="image/5.jpg" alt="album cover">
                        </span>
                        <span class="highlight"></span>
                    </div>
                    <div class="track-info">
                        <p class="title">
                            {{ $random[0]->description }}
                        </p>
                        <p class="artist-outer" style="opacity: 1;"><span
                                    class="artist">{{ $random[0] -> single }}</span></p>
                        <div class="rating"><span class="rating-level rating-star on"></span>
                    ...
                    <div class="player-controls">
                        <div class="main">
                            <div class="previousmp3 jp-previous"></div>
                            <div class="playmp3 jp-play" style="display: block;"></div>
                            <div class="pausemp3 jp-pause" style="display: none;"></div>
                            <div class="nextmp3 jp-next"></div>
                            <span class="unused-controls">
								<span class="jp-video-play" style="display: none;">
								</span>                   
								<span class="jp-stop">
								</span>                 
								<span class="jp-mute">
								</span>              
								<span class="jp-unmute" style="display: none;">
								</span>              
								<span class="jp-volume-bar">
								</span>                   
								<span class="jp-volume-bar-value" style="width: 80%;">
								</span>                   
								<span class="jp-volume-max">
								</span>                    
								<span class="jp-current-time">00:17
								</span>                   
								<span class="jp-duration">4:29
								</span>                
								<span class="jp-full-screen">
								</span>                 
								<span class="jp-restore-screen" style="display: none;">
								</span>                 
								<span class="jp-repeat">
								</span>              
								<span class="jp-repeat-off" style="display: none;">
								</span>       
								<span class="jp-gui">
								</span>          
							</span>
                ...
                <div class="tracklist show-more-button">
                    <ol class="tracks" style="height: 105px;">
                        ...
                        <li class="track" value="{{ $value -> name }}">
                            <span class="title">{{ $value -> description }}</span>
                            ...
                            <a href="#" class="buy" target="_blank">$17 BUY</a>
                        </li>
                        @endforeach
                    </ol>
                ...
                <div class="jPlayer-container" id="jp_jplayer_0" style="width: 0px; height: 0px;">
                    ...
                    <audio id="audio" preload="metadata" src="mp3/KhocChoNguoiDi.mp3"
                           title="Khóc cho người đi"></audio>
    ...
    <div class="row row-fluid clearfix mbf">
        <div class="span8">
            <div class="def-block">
                ...
                <div class="news row-fluid animtt fadeUp" data-gen="fadeUp" style="">
                    <div class="span5"><img class="four-radius" src="image/1.jpg" alt="#"></div>
                    <div class="span7">
                        ...
                        <p>Nine Inch Nails aren't on the bill, and they won't play the fest anytime soon. Soundwave
                            ...
                            Trent Reznor.</p>
                        <div class="meta">
                            <span> <i class="icon-time mi"></i>August 26, 2013 5:09 AM </span> | <span> <a href="#"><i
                                            class="icon-comments-alt"></i> 14</a> </span>
                        </div><!-- meta -->
                ...
                <div class="news row-fluid animtt fadeUp" data-gen="fadeUp" style="">
                    <div class="span5"><img class="four-radius" src="image/5.jpg" alt="#"></div>
                    <div class="span7">
                        ...
                        <p>Nine Inch Nails aren't on the bill, and they won't play the fest anytime soon. Soundwave
                            ...
                            Trent Reznor.</p>
                        <div class="meta">
                            <span> <i class="icon-time mi"></i>August 24, 2013 8:10 PM </span> | <span> <a href="#"><i
                                            class="icon-comments-alt"></i> 5</a> </span>
                        </div><!-- meta -->
                        <a href="news_single.html" class="sign-btn tbutton small"><span>Read More</span></a>
                    </div><!-- span7 -->
                </div><!-- news -->
                ...
                <div class="news row-fluid animtt fadeUp" data-gen="fadeUp" style="">
                    <div class="span5"><img class="four-radius" src="image/3.jpg" alt="#"></div>
                    <div class="span7">
                        ...
                        <p>Nine Inch Nails aren't on the bill, and they won't play the fest anytime soon. Soundwave
                            ...
                            Trent Reznor.</p>
                        <div class="meta">
                            <span> <i class="icon-time mi"></i>August 20, 2013 2:00 AM </span> | <span> <a href="#"><i
                                            class="icon-comments-alt"></i> 27</a> </span>
                        </div><!-- meta -->
                        <a href="news_single.html" class="tbutton small"><span>Read More</span></a>
                    </div><!-- span7 -->
                </div><!-- news -->

                <div class="load-news tac"><a class="tbutton small"><span>Load More</span></a><img
                            style="display: none;margin: 0 auto" src="images/loading2.gif"><h4
                            style="display: none;color:#ccc;border: 0">Sorry! Not More News.</h4></div>
            </div><!-- def block -->
        </div><!-- span8 news -->
        ...
        <div class="span4">
            ...
            <div class="def-block widget animtt fadeUp" data-gen="fadeUp" style="">
                ...
                <div class="widget-content row-fluid">
                    <div class="videos clearfix flexslider" style="height: 200px;">
                        {{--<ul class="slides">--}}
                    ...
                    <div class="scroll-mp3" style="height: 220px; overflow: hidden;" tabindex="5000">
                        <div class="content">
                            <ul class="tab-content-items">
                                <li class="clearfix">
                                    <a class="m-thumbnail" href="mp3_single_half.html"><img src="image/thumb-mp3-1.jpg"
                                                                                            alt="#" width="50"
                                                                                            height="50"></a>
                                ...
                                <li class="clearfix">
                                    <a class="m-thumbnail" href="mp3_single_half.html"><img src="image/thumb-mp3-6.jpg"
                                                                                            alt="#" width="50"
                                                                                            height="50"></a>
                                ...
                                <li class="clearfix">
                                    <a class="m-thumbnail" href="mp3_single_half.html"><img src="image/thumb-mp3-8.jpg"
                                                                                            alt="#" width="50"
                                                                                            height="50"></a>
                                ...
                                <li class="clearfix">
                                    <a class="m-thumbnail" href="mp3_single_half.html"><img src="image/thumb-mp3-4.jpg"
                                                                                            alt="#" width="50"
                                                                                            height="50"></a>
                                ...
                                <li class="clearfix">
                                    <a class="m-thumbnail" href="mp3_single_half.html"><img src="image/thumb-mp3-9.jpg"
                                                                                            alt="#" width="50"
                                                                                            height="50"></a>
